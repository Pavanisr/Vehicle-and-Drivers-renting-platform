  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const res = await axios.get("http://localhost:3000/api/drivers/profile", {
        ...
        <div className="row justify-content-center g-4">
          ...
          <div className="col-md-6">
            <div className="card p-4 shadow-lg border-0">
              ...
              <div className="mb-4">
                <h6 className="text-primary fw-bold">Rating</h6>
                <p className="fw-semibold">{profile.rating}</p>
              </div>

              <div className="mb-4">
                <h6 className="text-primary fw-bold">Created At</h6>
